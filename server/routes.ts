...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/opportunities/discover", async (req, res) => {
    try {
      console.log("Received discovery request: ", JSON.stringify(req.body));
      ...
      if (!skills || !timeAvailability || !riskAppetite || !incomeGoals) {
        console.log("Missing required fields in request:", { skills, timeAvailability, riskAppetite, incomeGoals });
